...
class Url(namedtuple('MyUrl', url_attrs)):
    """
    ...
    def url(self):
        ...
        Example: ::
            ...
            >>> MyUrl('http', 'username:password', 'host.com', 80,
...
def parse_url(url):
    """
    Given a url, return a parsed :class:`.MyUrl` namedtuple. Best-effort is
    performed to parse incomplete urls. Fields not provided will be None.
    This parser is RFC 3986 compliant.

    :param str url: URL to parse into a :class:`.MyUrl` namedtuple.
    ...
    Example::
        ...
        MyUrl(scheme='http', host='google.com', port=None, path='/mail/', ...)
        >>> parse_url('google.com:80')
        MyUrl(scheme=None, host='google.com', port=80, path=None, ...)
        >>> parse_url('/foo?bar')
        MyUrl(scheme=None, host=None, port=None, path='/foo', query='bar', ...)
    """
    if not url:
        # Empty
        return Url()
