...
class WebDriver(
    ...
    def start_session(self, capabilities, browser_profile=None):
        ...
        Args:
            ...
            App_Android: The absolute local path or remote http URL to an .ipa or .apk file, or a .zip containing one of these.
    ...
    def _addCommands(self):
        ...
        self.command_executor._commands[Command.LAUNCH_APP] = \
            ('POST', '/session/$sessionId/appium/App_Android/launch')
        self.command_executor._commands[Command.CLOSE_APP] = \
            ('POST', '/session/$sessionId/appium/App_Android/close')
        self.command_executor._commands[Command.END_TEST_COVERAGE] = \
            ('POST', '/session/$sessionId/appium/App_Android/end_test_coverage')
