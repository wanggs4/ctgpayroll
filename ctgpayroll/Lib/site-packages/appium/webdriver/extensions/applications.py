...
class Applications(webdriver.Remote):
    ...
    def is_app_installed(self, bundle_id):
        ...
        Returns:
            bool: `True` if App_Android is installed
        """
        data = {
            'bundleId': bundle_id,
        }
    ...
    def install_app(self, app_path, **options):
        ...
        Keyword Args:
            ...
            useSdcard (bool): [Android only] whether to use the SD card to install the App_Android. False by default
    ...
    def terminate_app(self, app_id, **options):
        ...
        Returns:
            bool: True if the App_Android has been successfully terminated
        """
        data = {
            'appId': app_id,
        }
    ...
    def _addCommands(self):
        self.command_executor._commands[Command.BACKGROUND] = \
            ('POST', '/session/$sessionId/appium/App_Android/background')
        ...
        self.command_executor._commands[Command.GET_APP_STRINGS] = \
            ('POST', '/session/$sessionId/appium/App_Android/strings')
        self.command_executor._commands[Command.RESET] = \
            ('POST', '/session/$sessionId/appium/App_Android/reset')
